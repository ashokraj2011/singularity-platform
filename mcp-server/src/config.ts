...
const MCP_LIMITS = {
  ...
  COMMAND_TOOL_TIMEOUT_MS: 60 * 60_000,
  RUNNER_HEALTH_TIMEOUT_MS: 300_000,
  STRICT_HEALTH_GIT_TIMEOUT_MS: 60_000,
  STRICT_HEALTH_LLM_TIMEOUT_MS: 300_000,
  LLM_PROVIDER_STATUS_TIMEOUT_MS: 300_000,
  AUDIT_GOV_CHECK_TIMEOUT_MS: 300_000,
  AUDIT_GOV_EMIT_TIMEOUT_MS: 300_000,
  AUDIT_GOV_APPROVAL_TIMEOUT_MS: 300_000,
  RUNTIME_BRIDGE_HEARTBEAT_MS: 600_000,
  RUNTIME_BRIDGE_HANDSHAKE_TIMEOUT_MS: 300_000,
  RUNTIME_BRIDGE_RECONNECT_MIN_BACKOFF_MS: 300_000,
  RUNTIME_BRIDGE_RECONNECT_MAX_BACKOFF_MS: 600_000,
  WORKTREE_GIT_HASH_TIMEOUT_MS: 300_000,
  WORKTREE_GIT_WRITE_TIMEOUT_MS: 300_000,
  WORKTREE_TEST_TIMEOUT_MS: 60 * 60_000,
  SOURCE_DISCOVERY_TIMEOUT_MS: 300_000,
  SOURCE_MATERIALIZER_GIT_TIMEOUT_MS: 600_000,
  RG_SEARCH_TIMEOUT_MS: 300_000,
  ...
  FORMAL_VERIFICATION_HTTP_GRACE_MS: 60_000,
...
const schema = z.object({
  ...
  MCP_WORKSPACE_BRANCH_PROBE_TIMEOUT_MS: boundedPositiveInt(2_000, MCP_LIMITS.WORKSPACE_BRANCH_PROBE_TIMEOUT_MS),
  ...
  MCP_COMMAND_TOOL_DEFAULT_TIMEOUT_MS: boundedPositiveInt(120_000, MCP_LIMITS.COMMAND_TOOL_TIMEOUT_MS),
  MCP_COMMAND_TOOL_MAX_TIMEOUT_MS: boundedPositiveInt(600_000, MCP_LIMITS.COMMAND_TOOL_TIMEOUT_MS),
  ...
  MCP_LLM_PROVIDER_STATUS_TIMEOUT_MS: boundedPositiveInt(2_000, MCP_LIMITS.LLM_PROVIDER_STATUS_TIMEOUT_MS),
  MCP_AUDIT_GOV_CHECK_TIMEOUT_MS: boundedPositiveInt(3_000, MCP_LIMITS.AUDIT_GOV_CHECK_TIMEOUT_MS),
  MCP_AUDIT_GOV_EMIT_TIMEOUT_MS: boundedPositiveInt(5_000, MCP_LIMITS.AUDIT_GOV_EMIT_TIMEOUT_MS),
  MCP_AUDIT_GOV_APPROVAL_TIMEOUT_MS: boundedPositiveInt(5_000, MCP_LIMITS.AUDIT_GOV_APPROVAL_TIMEOUT_MS),
  MCP_RUNTIME_BRIDGE_HEARTBEAT_MS: boundedPositiveInt(30_000, MCP_LIMITS.RUNTIME_BRIDGE_HEARTBEAT_MS),
  MCP_RUNTIME_BRIDGE_HANDSHAKE_TIMEOUT_MS: boundedPositiveInt(
    10_000,
    MCP_LIMITS.RUNTIME_BRIDGE_HANDSHAKE_TIMEOUT_MS,
  ),
  MCP_RUNTIME_BRIDGE_RECONNECT_MIN_BACKOFF_MS: boundedPositiveInt(
    1_000,
    MCP_LIMITS.RUNTIME_BRIDGE_RECONNECT_MIN_BACKOFF_MS,
  ),
  MCP_RUNTIME_BRIDGE_RECONNECT_MAX_BACKOFF_MS: boundedPositiveInt(
    60_000,
    MCP_LIMITS.RUNTIME_BRIDGE_RECONNECT_MAX_BACKOFF_MS,
  ),
  MCP_WORKTREE_GIT_HASH_TIMEOUT_MS: boundedPositiveInt(5_000, MCP_LIMITS.WORKTREE_GIT_HASH_TIMEOUT_MS),
  MCP_WORKTREE_GIT_WRITE_TIMEOUT_MS: boundedPositiveInt(30_000, MCP_LIMITS.WORKTREE_GIT_WRITE_TIMEOUT_MS),
  MCP_WORKTREE_TEST_DEFAULT_TIMEOUT_MS: boundedPositiveInt(5 * 60_000, MCP_LIMITS.WORKTREE_TEST_TIMEOUT_MS),
  MCP_WORKTREE_TEST_MAX_TIMEOUT_MS: boundedPositiveInt(10 * 60_000, MCP_LIMITS.WORKTREE_TEST_TIMEOUT_MS),
  MCP_SOURCE_DISCOVERY_TIMEOUT_MS: boundedPositiveInt(20_000, MCP_LIMITS.SOURCE_DISCOVERY_TIMEOUT_MS),
  MCP_SOURCE_MATERIALIZER_GIT_TIMEOUT_MS: boundedPositiveInt(
    120_000,
    MCP_LIMITS.SOURCE_MATERIALIZER_GIT_TIMEOUT_MS,
  ),
  MCP_RG_SEARCH_TIMEOUT_MS: boundedPositiveInt(10_000, MCP_LIMITS.RG_SEARCH_TIMEOUT_MS),
  ...
  FORMAL_VERIFICATION_HTTP_GRACE_MS: boundedPositiveInt(1_000, MCP_LIMITS.FORMAL_VERIFICATION_HTTP_GRACE_MS),
...
if (parsed.data.MCP_RUNTIME_BRIDGE_RECONNECT_MIN_BACKOFF_MS > parsed.data.MCP_RUNTIME_BRIDGE_RECONNECT_MAX_BACKOFF_MS) {
  console.error(
    "FATAL: MCP_RUNTIME_BRIDGE_RECONNECT_MIN_BACKOFF_MS must be less than or equal to " +
      "MCP_RUNTIME_BRIDGE_RECONNECT_MAX_BACKOFF_MS so relay reconnect backoff cannot be inverted.",
  );
  process.exit(1);
}

if (parsed.data.MCP_WORKTREE_TEST_DEFAULT_TIMEOUT_MS > parsed.data.MCP_WORKTREE_TEST_MAX_TIMEOUT_MS) {
  console.error(
...
if (parsed.data.MCP_COMMAND_TOOL_DEFAULT_TIMEOUT_MS > parsed.data.MCP_COMMAND_TOOL_MAX_TIMEOUT_MS) {
  console.error(
