...
_DEFAULT_MAX_RUNTIME_CAPABILITY_TAGS = 32
_DEFAULT_MAX_RUNTIME_CAPABILITY_TAG_LEN = 96
_MAX_RUNTIME_CAPABILITY_TAGS_CAP = 256
_MAX_RUNTIME_CAPABILITY_TAG_LEN_CAP = 1024
_DEFAULT_MAX_RUNTIME_USER_ID_LEN = 128
_DEFAULT_MAX_RUNTIME_ID_LEN = 128
_DEFAULT_MAX_RUNTIME_TENANT_ID_LEN = 128
_DEFAULT_MAX_RUNTIME_TYPE_LEN = 64
_DEFAULT_MAX_RUNTIME_DEVICE_NAME_LEN = 200
_DEFAULT_MAX_RUNTIME_REQUEST_ID_LEN = 128
_MAX_RUNTIME_IDENTITY_LEN_CAP = 1024
_MAX_RUNTIME_TYPE_LEN_CAP = 256
_MAX_RUNTIME_DEVICE_NAME_LEN_CAP = 512
_MAX_RUNTIME_REQUEST_ID_LEN_CAP = 1024
...
_MAX_RUNTIME_CAPABILITY_TAGS = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_CAPABILITY_TAGS",
    default=_DEFAULT_MAX_RUNTIME_CAPABILITY_TAGS,
    min_value=1,
    max_value=_MAX_RUNTIME_CAPABILITY_TAGS_CAP,
    logger=log,
)
_MAX_RUNTIME_CAPABILITY_TAG_LEN = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_CAPABILITY_TAG_LENGTH",
    default=_DEFAULT_MAX_RUNTIME_CAPABILITY_TAG_LEN,
    min_value=8,
    max_value=_MAX_RUNTIME_CAPABILITY_TAG_LEN_CAP,
    logger=log,
)
_MAX_RUNTIME_USER_ID_LEN = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_USER_ID_LENGTH",
    default=_DEFAULT_MAX_RUNTIME_USER_ID_LEN,
    min_value=16,
    max_value=_MAX_RUNTIME_IDENTITY_LEN_CAP,
    logger=log,
)
_MAX_RUNTIME_ID_LEN = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_RUNTIME_ID_LENGTH",
    default=_DEFAULT_MAX_RUNTIME_ID_LEN,
    min_value=16,
    max_value=_MAX_RUNTIME_IDENTITY_LEN_CAP,
    logger=log,
)
_MAX_RUNTIME_TENANT_ID_LEN = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_TENANT_ID_LENGTH",
    default=_DEFAULT_MAX_RUNTIME_TENANT_ID_LEN,
    min_value=16,
    max_value=_MAX_RUNTIME_IDENTITY_LEN_CAP,
    logger=log,
)
_MAX_RUNTIME_TYPE_LEN = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_RUNTIME_TYPE_LENGTH",
    default=_DEFAULT_MAX_RUNTIME_TYPE_LEN,
    min_value=3,
    max_value=_MAX_RUNTIME_TYPE_LEN_CAP,
    logger=log,
)
_MAX_RUNTIME_DEVICE_NAME_LEN = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_DEVICE_NAME_LENGTH",
    default=_DEFAULT_MAX_RUNTIME_DEVICE_NAME_LEN,
    min_value=16,
    max_value=_MAX_RUNTIME_DEVICE_NAME_LEN_CAP,
    logger=log,
)
_MAX_RUNTIME_REQUEST_ID_LEN = bounded_int_env(
    "CONTEXT_FABRIC_RUNTIME_BRIDGE_MAX_REQUEST_ID_LENGTH",
    default=_DEFAULT_MAX_RUNTIME_REQUEST_ID_LEN,
    min_value=16,
    max_value=_MAX_RUNTIME_REQUEST_ID_LEN_CAP,
    logger=log,
)
