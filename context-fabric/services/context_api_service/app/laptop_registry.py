...
_MIN_RUNTIME_BRIDGE_PAYLOAD_BYTES = 1024
_MAX_RUNTIME_BRIDGE_PAYLOAD_BYTES = 128 * 1024 * 1024
...
MAX_PAYLOAD_BYTES = bounded_int_env(
    ...
    min_value=_MIN_RUNTIME_BRIDGE_PAYLOAD_BYTES,
    max_value=_MAX_RUNTIME_BRIDGE_PAYLOAD_BYTES,
    logger=log,
)
