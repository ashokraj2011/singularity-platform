...
DIRECT_GATEWAY_PATHS='agent-and-tools/packages/shared/src/llm-gateway/|agent-and-tools/apps/agent-runtime/src/modules/capabilities/bootstrap-phase3-distill\.ts|agent-and-tools/apps/agent-runtime/src/modules/capabilities/world-model-view-builder\.service\.ts|claim-registry/src/lib/gateway\.ts|audit-governance-service/src/engine/|audit-governance-service/test/|context-fabric/tests/|tools/capability-harness/|tests/chaos/|context-fabric/services/context_api_service/app/governed/llm_client\.py|context-fabric/services/context_api_service/app/governed/turn\.py|context-fabric/services/context_api_service/app/laptop_registry\.py|bin/copilot-cli-server\.js'
