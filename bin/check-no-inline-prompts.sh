...
ALLOW_RE='(prompt-composer/prisma/seed\.ts|agent-runtime/prisma/seed\.ts|mcp-server/src/tools/|mcp-server/src/llm/mock\.ts|mcp-server/src/audit/provenanceExtractor\.ts|mcp-server/src/lib/governance-policy\.ts|mcp-server/src/mcp/invoke\.ts|mcp-server/src/mcp/tools\.ts|mcp-server/src/mcp/work\.ts|agent-service/src/tool/lib/seed-core-tools\.ts|audit-governance-service/src/engine/extract-lesson\.ts|\.test\.ts$|\.contract\.test\.ts$|/bin/|/docs/|/\.singularity/|/scripts/|/tests/|/test/|/prisma/seed)'
