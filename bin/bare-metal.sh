...
SQL
  ...
  boot agent-runtime    "cd agent-and-tools/apps/agent-runtime   && PORT=3003 DATABASE_URL=\"$DATABASE_URL_AGENT_TOOLS\" IAM_SERVICE_URL=\"$IAM_SERVICE_URL\" AUDIT_GOV_URL=\"$AUDIT_GOV_URL\" AUDIT_GOV_SERVICE_TOKEN=\"$AUDIT_GOV_SERVICE_TOKEN\" MCP_SERVER_URL=\"$MCP_SERVER_URL\" MCP_BEARER_TOKEN=\"$MCP_BEARER_TOKEN\" JWT_SECRET=\"$JWT_SECRET\" LLM_GATEWAY_URL=\"$LLM_GATEWAY_URL\" WORLD_MODEL_DISTILL_MODEL_ALIAS=\"${WORLD_MODEL_DISTILL_MODEL_ALIAS:-claude-haiku-4-5-20251001}\" npm run dev"
