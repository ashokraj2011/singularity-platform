    ...
    <div style={shell}>
      <header style={topbar}>
        <Link href="/studio" style={brand}>
          ...
          <b style={{ fontSize: 13.5, fontWeight: 640, letterSpacing: "-0.01em" }}>ELM Studio</b>
        </Link>
        {crumb && <><span style={{ color: "var(--studio-faint)" }}>/</span><div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0, color: "var(--studio-ink-dim)", fontSize: 13 }}>{crumb}</div></>}
