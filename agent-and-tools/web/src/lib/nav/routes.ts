...
export const ROUTES: RouteMeta[] = [
  ...
  { id: "concept-studio", label: "Concept Studio", href: "/concept-studio", group: "Agent Studio", icon: Lightbulb, priority: "secondary", surfaceType: "agent", description: "Create, explore, and review concepts in a human-guided idea map.", keywords: ["creative studio", "ideas", "concept map", "concept", "proposal", "archive"] },
  ...
  { id: "workflows-reconciliation", label: "Reconciliation", href: "/workflows/reconciliation", group: "Workflows", icon: ClipboardCheck, priority: "secondary", surfaceType: "workflow", description: "Submissions and reconciliation verdicts across all Work Items.", keywords: ["reconciliation", "submission", "verdict", "spec", "review"] },
  ...
  { id: "identity-effective-access", label: "Effective Access", href: "/identity/effective-access", group: "Identity and Access", icon: ShieldCheck, priority: "secondary", surfaceType: "identity", description: "See the permissions that apply to your current tenant and session." },
