...
export function referenceOnlySdlcGallery(capabilityId: string | null = null) {
  return {
    generatedAt: new Date().toISOString(),
    capabilityId,
    referenceOnly: true,
    authRequired: true,
    message: "Login is required to inspect saved workflow templates. Showing the safe built-in SDLC intent catalog.",
    items: SDLC_INTENTS.map((intent) => ({
      ...intent,
      templates: [],
