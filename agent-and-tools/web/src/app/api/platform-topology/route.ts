...
export async function GET(request: NextRequest) {
  ...
  const configs: ProbeConfig[] = [
    ...
    },
    {
      ...
      description: "Context, memory, knowledge, receipts, artifact context, and MCP bridge coordination.",
      kind: "api",
      group: "core",
    ...
    },
    {
      id: "mcp-server",
      label: "MCP Runtime",
      description: "Dial-in tool runner near the operator workspace; can live outside the platform stack.",
      kind: "runtime",
      group: "runtime",
    ...
    },
    {
      id: "llm-gateway",
      label: "LLM Gateway",
      description: "Remote-capable model gateway used by MCP, Context Fabric, Prompt Composer, and runtime distillation.",
      kind: "runtime",
      group: "runtime",
  ...
  const edgeBase: Omit<TopologyEdge, "status" | "message">[] = [
    ...
    { id: "context-mcp", source: "context-api", target: "mcp-server", label: "dial-in tools", protocol: "HTTP/WS", required: false },
    { id: "tool-mcp", source: "tool-service", target: "mcp-server", label: "tool runner", protocol: "HTTP", required: false },
    { id: "composer-mcp", source: "prompt-composer", target: "mcp-server", label: "model/tools", protocol: "HTTP", required: false },
    { id: "mcp-llm", source: "mcp-server", target: "llm-gateway", label: "model calls", protocol: "HTTP", required: false },
