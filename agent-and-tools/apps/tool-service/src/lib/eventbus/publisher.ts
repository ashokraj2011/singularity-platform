 ...
 * tool-service uses raw pg (no Prisma) — INSERT into tool.event_outbox
 * + pg_notify('event_outbox_tool_service', id) so the dispatcher picks
 * the row up immediately.
 */
import { pool } from "../../database";

export const EVENT_CHANNEL = "event_outbox_tool_service";
