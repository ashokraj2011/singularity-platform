...
const AGENT_RUNTIME_LIMITS = {
  ...
  POLL_WORKER_INITIAL_DELAY_SEC: 300,
  POLL_WORKER_GIT_NETWORK_TIMEOUT_SEC: 900,
  POLL_WORKER_GIT_LOCAL_TIMEOUT_SEC: 300,
  ...
  AGENT_GOVERNANCE_LIMITS_TIMEOUT_SEC: 300,
...
const schema = z.object({
  ...
  POLL_WORKER_GIT_NETWORK_TIMEOUT_SEC: boundedInt(
    60,
    1,
    AGENT_RUNTIME_LIMITS.POLL_WORKER_GIT_NETWORK_TIMEOUT_SEC,
  ),
  POLL_WORKER_GIT_LOCAL_TIMEOUT_SEC: boundedInt(
    30,
    1,
    AGENT_RUNTIME_LIMITS.POLL_WORKER_GIT_LOCAL_TIMEOUT_SEC,
  ),
  ...
  AGENT_GOVERNANCE_LIMITS_TIMEOUT_SEC: boundedInt(
    5,
    1,
    AGENT_RUNTIME_LIMITS.AGENT_GOVERNANCE_LIMITS_TIMEOUT_SEC,
  ),
  ...
  AGENT_CONTRACT_PIN_RETRY_DELAY_MS: boundedInt(
    150,
    0,
    AGENT_RUNTIME_LIMITS.AGENT_CONTRACT_PIN_RETRY_DELAY_MS,
  ),
