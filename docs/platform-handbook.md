...
patch apply, branch, checkpoint, and fs/git tool helpers. Both are bounded
`1..300000`, keeping slow worktree filesystems tunable without making
browser-initiated edits wait forever.
