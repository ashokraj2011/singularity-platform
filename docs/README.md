...
- [Git History Change Explainer](./git-history-change-explainer.md) - generate date-range change explanations, release notes, risk signals, and evidence-pack inputs from local git history.
- [Runtime Discovery](./runtime-discovery.md) - standardized runtime discovery surface.
- [Singularity Runtime Distribution](./singularity-runtime.md) - one-time enrollment, local MCP + LLM setup, key storage, and runtime operations.
