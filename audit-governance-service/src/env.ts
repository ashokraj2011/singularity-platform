...
export function boundedInteger(raw: string | number | undefined, options: BoundedNumberOptions): number {
...
export function boundedEnvInteger(name: string, options: BoundedNumberOptions): number {
